            ...
            <table class="table table-striped">
                ...
                <tbody id="tableMhs">
                    ...
                    <tr>
                        ...
                        <td>{{$akun->password}}</td>
                        <td>{{$akun->categori}}</td>
                        <td><a href="{{route('akun.edit')}}" class="btn-warning btn-sm">Edit</td>
                        <td><a href="{{route('akun.delete', $mahasiswa)}}" class="btn-danger btn-sm" onclick="return confirm('Data akan dihapus, lanjutkan?')">Delete</a></td>
